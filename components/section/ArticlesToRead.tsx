...
export default function ArticlesToRead() {
	...
	const articlesToReadWrapper = (
		<div>
			<h1 className="font-semibold text-4xl leading-[54px]">Articles to Read</h1>
			<p className="font-medium lg:w-3/5 xl:w-7/12">
				Dive Deep into Engaging Content, In-Depth Analysis, and the Latest Marvel News. Stay
				updated with the most intriguing stories, character breakdowns, and cinematic
				insights. Explore a curated selection of articles that keep you connected to the
				Marvel universe.
			</p>
		</div>
	);
	...
	const articlesCarousel = (
		...
		>
			...
			<div className="flex justify-between items-center">
				<RoundButton direction="left" className="custom-prev w-[60px] h-[60px]" />
				<div className="swiper-pagination"></div>
				<RoundButton direction="right" className="custom-next w-[60px] h-[60px]" />
			</div>
		</Swiper>
	);
