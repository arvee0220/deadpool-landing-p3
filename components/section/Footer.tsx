...
export default function Footer() {
	...
	const subscribeWrapper = (
		<div className="w-full flex flex-col xl:flex-row justify-between xl:items-center gap-[50px] bg-deadpool-iconbackground rounded-[60px] px-11 py-10 xl:py-[82px]">
			<div className="text-deadpool-primary">
				<h1 className="text-4xl font-semibold mb-2">Subscribe for you to be updated</h1>
				<p className="text-base">Stay Updated on the Latest Marvel News and Updates.</p>
			</div>
	...
	const siteDetails = (
		<div className="w-full lg:w-[344px] h-[200px] lg:h-auto flex flex-col justify-between pr-[58px] ">
			...
			<p className="md:w-3/5 lg:w-full">
				Your ultimate destination for all things film. Explore in-depth review, breaking
				news, and exclusive insights into the latest movies and cinematic trends.
			</p>
	...
	const contactLinksWrapper = (
		<div className="flex flex-col gap-5">
			<h1 className="font-semibold text-deadpool-primary">{contactLinks.linkHeader}</h1>
		...
		<div className="grid grid-cols-3 lg:grid-cols-4 gap-x-10 xl:gap-x-0 gap-y-24">
			{footerLinks.map((item, index) => (
				<div key={index} className="flex flex-col gap-5">
					<h1 className="font-semibold text-deadpool-primary">{item.linkHeader}</h1>
					{item.links.map((link) => (
	...
	return (
		<div className="w-full flex flex-col text-deadpool-body bg-deadpool-neutral tracking-tighter px-[25px] md:px-[75px] py-7">
			...
			<h1 className="w-full text-center mt-20">All Rights Reserved. NightCinema</h1>
		</div>
	);
}
