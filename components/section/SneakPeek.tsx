...
function SneakPeek() {
	...
	return (
		<MaxWidthWrapper className="mt-24 mb-32">
			<div className="flex flex-col lg:flex-row md:justify-between gap-10" id="sneakpeek">
				<div className="flex flex-col space-y-6">
					...
					<p className="text-sm text-stone-300 -tracking-tighter leading-5 text-pretty max-w-prose">
						Featuring the characters Deadpool and Wolverine, produced by Marvel Studios.
						The film received generally positive reviews from critics and has grossed
						over $211 million worldwide.
					</p>
